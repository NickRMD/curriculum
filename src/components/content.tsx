      ...
      <main className="flex flex-col rounded-tr-md rounded-br-md h-[calc(100vh-1rem)] px-2.5 py-2 w-screen mr-2 mt-2 mb-2 bg-stone-300">
        <div className="flex flex-col p-1 border-b border-black" id="resumo">
          ...
          <p>
            ...
            and C (currently still learning the latter). I have had three full professional experiences so far, working with at least
            some of the languages mentioned. In my free time, I apply my skills to my&nbsp;
            <a className="text-emerald-950 duration-200 transition-all hover:text-emerald-600" target="_blank" href="https://github.com/NickRMD">GitHub</a> repositories.
          </p>
        </div>
        <div className="p-1">
